...
# O agente baseado em objetivos sabe onde os itens estão no mapa
# ele move-se em direção aos itens que estão mais perto no menor caminho possível
class GoalAgent(RationalAgent):
    ...
    def read_map(self): # Lê o mapa e retorna as coordenadas dos itens
        goals = []
        ...
        return sorted(goals, key=sum) # Retorna as coordenadas dos itens em ordem de distância
